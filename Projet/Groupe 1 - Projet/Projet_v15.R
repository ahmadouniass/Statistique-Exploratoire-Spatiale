                 ...
                 column(
                   ...
                   div(
                     ...
                     tabsetPanel(
                       ...
                       tabPanel(
                         "Chart",
                         plotlyOutput("chartOutput") # CHart ----------------------------
                       ),
                       tabPanel(  
                         "Malaria GIF", # Image -----------
                         conditionalPanel(
...
server <- function(input, output, session) {
  ...
  output$Guidecontent <- renderUI({
    fluidPage(
      ...
      img(src = "bloc_1.png", height = "250px", width = "700px", alt = "Présentation de l'application à l'ouverture"),
      p(" "),
      ...
      img(src = "bloc_3.png", height = "250px", width = "700px", alt = "Description des variables"),
      p(" "),
      p("Le bloc 3 présente une description de la variable sélectionnée."),
      
      
      h3("Affichage de la carte et informations au clic"),
      img(src = 'bloc_4.png', height = "250px", width = "700px", alt = "Selection au clic sur la carte"),
      p(" "),
      ...
      p(" "),
      img(src = "bloc_5.png", height = "150px", width = "700px", alt = "Selection 'manuelle' "),
      p(" "),
      ...
      h3("Autres onglets"),
      img(src = "nav.png", height = "100px", width = "900px", alt = "Autres"),
      p(" "),
  ...
  output$chartOutput <- renderPlotly({
    ...
    fluidRow(
      ...
      column(
        ...
        div(
          class = "note-box",
          style = "border: 1px solid #ddd; padding: 15px; border-radius: 5px; background-color: #f9f9f9;",
          h4("TNotes techniques 3", style = "color: white; background-color: red; padding: 5px; border-radius: 5px;"),
